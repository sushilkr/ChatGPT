...
jQuery(document).ready(function() {
    ...
    jQuery('#copy_button').on('click', function () {
      //jQuery('.copy-info').html('');
      navigator.clipboard.writeText(jQuery('textarea[name="replace_textfield"]').val());
      alert(jQuery('textarea[name="replace_textfield"]').val() + 'The content is copied to clipboard.');
      /*setTimeout(function () {
          jQuery(".copy-info").html('');
        }, 5000);*/
    });
