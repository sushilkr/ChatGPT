...
jQuery(document).ready(function() {
    ...
    jQuery('#copy_button').on('click', function () {
      jQuery('.info').html('<small class="info"></small>');
      jQuery('#replace-textfield-container').append('<small class="info"></small>');
      var field_selector = 'textarea[name="replace_textfield"]';
      jQuery(field_selector).select();
      navigator.clipboard.writeText(jQuery(field_selector).val());
      jQuery('.info').html('<small class="info">The content is copied to clipboard.</small>');
